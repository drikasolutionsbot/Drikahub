        ...
        <footer className="relative z-10 border-t border-white/15 py-5 px-4">
          <div className="max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-4">
              <a href="https://discord.com/invite/xJ9g2TA98e" target="_blank" rel="noopener noreferrer" className="text-white/70 hover:text-primary transition-colors" aria-label="Discord">
